...
export function GeminiIcon({ className = '', size = 28, variant = 'gradient' }: GeminiIconProps) {
  const fill = variant === 'white' ? 'currentColor' : 'url(#gemini-grad)';
  return (
    <svg
      width={size}
      height={size}
...
export function FullscreenExitIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden>
...
export function ExpandMoreIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
